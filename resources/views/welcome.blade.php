...
<body class="max-w-screen-xl mx-auto font-sans antialiased text-gray-900">
    ...
    <footer class="relative flex flex-col items-center gap-3 py-5 mt-12 text-white bg-black" id="footer">
        ...
        <div class="z-20 flex flex-wrap justify-center gap-3 px-8">
            {{-- Facebook --}}
            <a href="#" class="block p-1 border-2 border-blue-600 rounded-full w-max">
                <span class="flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full">
                    <svg width="13" height="25" viewBox="0 0 16 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_40_164)">
                        <path d="M13.957 15.1397L14.668 10.5067H10.2225V7.50025C10.2225 6.23275 10.8435 4.99725 12.8345 4.99725H14.8555V1.05275C14.8555 1.05275 13.0215 0.739746 11.268 0.739746C7.60703 0.739746 5.21403 2.95875 5.21403 6.97575V10.5067H1.14453V15.1397H5.21403V26.3397H10.2225V15.1397H13.957Z" fill="white"/>
                        </g>
                        <defs>
                        <clipPath id="clip0_40_164">
                        <rect width="16" height="25.6" fill="white" transform="translate(0 0.739746)"/>
                        </clipPath>
                        </defs>
                    </svg>
                </span>
            ...
            {{-- WhatsApp --}}
            <a href="#" class="block p-1 border-2 border-green-500 rounded-full w-max">
            ...
            <a href="#" class="block p-1 border-2 border-blue-600 rounded-full w-max">
                <span class="flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full">
                    <svg width="50" height="51" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M25 10.5396C16.7157 10.5396 10 17.2553 10 25.5396C10 33.8238 16.7157 40.5396 25 40.5396C33.2843 40.5396 40 33.8238 40 25.5396C40 17.2553 33.2843 10.5396 25 10.5396ZM31.9527 20.7408C31.727 23.1126 30.7503 28.8685 30.2531 31.525C30.0429 32.6491 29.6288 33.026 29.2281 33.0628C28.3571 33.143 27.6955 32.4872 26.8518 31.9341C25.5317 31.0687 24.7858 30.53 23.5043 29.6855C22.0233 28.7096 22.9834 28.1734 23.8274 27.2964C24.0483 27.067 27.8863 23.5761 27.9606 23.2594C27.9698 23.2198 27.9787 23.0719 27.8908 22.9942C27.8028 22.9165 27.6736 22.9429 27.5802 22.964C27.4478 22.994 25.3388 24.388 21.2531 27.1459C20.6545 27.557 20.1123 27.7573 19.6264 27.7468C19.0908 27.7352 18.0606 27.444 17.2947 27.195C16.3553 26.8897 15.6087 26.7282 15.6737 26.2097C15.7076 25.9395 16.0796 25.6633 16.7897 25.381C21.1625 23.4759 24.0784 22.2198 25.5373 21.6129C29.703 19.8802 30.5686 19.5792 31.1328 19.5692C31.2569 19.5671 31.5343 19.5979 31.714 19.7437C31.8335 19.8476 31.9097 19.9925 31.9275 20.1499C31.958 20.3453 31.9664 20.5435 31.9527 20.7408Z" fill="white"/>
                        </g>
                        <defs>
                        <clipPath id="clip0_40_168">
                        <rect width="30" height="30.9677" fill="white" transform="translate(10 10.0557)"/>
                        </clipPath>
                        </defs>
                    </svg>
                </span>
            ...
            {{-- XTwitter --}}
            <a href="#" class="block p-1 border-2 rounded-full border-sky-500 w-max">
